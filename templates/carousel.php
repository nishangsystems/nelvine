<!-- Carousel wrapper -->
<!-- <div  id="carouselMultiItemExample" class="carousel slide" data-bs-ride="carousel" > -->

  <!-- Inner -->
  <!-- <div class="carousel-inner py-4"> -->
    <!-- Single item -->
    <!-- <?php
        // $a = $con->query("SELECT * from images_a  order by id DESC ")->fetch_all() or die(mysqli_error($con));  
        // foreach ($a as $i => $v) { -->
            // print_r($a);
    //         ?>
...
<!-- Carousel wrapper -->
<div  id="carouselMultiItemExample2" class="carousel slide carousel-dark text-center" data-bs-ride="carousel" >
  <!-- Controls -->
