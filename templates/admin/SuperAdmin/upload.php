...
<form method="POST" action="" enctype="multipart/form-data">                                   
        ...
        UPDATE 
                    ...
                    <td ><a href="?upload&id=<?php echo $rows['id']; ?>&image=<?php  echo $rows['name']; ?>&hhh" class="btn btn-xs btn-danger" onclick="reurn confirm('Are you sure you wish to Update your payment Data')">Delete</a></td>
